...
"g.addV('person').property('id', 'Paul')
                 .property('name', 'Paul')
                 .property('gender', 'man')
                 .property('age', 50)
                 .property('pk', 'pk')"
...
~id,~label,name:String,gender:String,age:String 
Paul,Person,Paul,man,50
Jean,Person,Jean,man,48
Dan,Person,Dan,man,23
Marc,Person,Marc,man,30
John,Person,John,man,31
Zoey,Person,Zoey,woman,52
Ava,Person,Ava,woman,23
Olivia,Person,Olivia,woman,58
Mia,Person,Mia,woman,51
Madison,Person,Madison,woman,37

Vertice Merchant
~id,~label,name:String,street:String,address:String 
Just_Brew_It,Merchant,Just_Brew_It,'826 Anmoore Road','San Bernardino CA 92410'

"g.addV('merchant').property('id', 'Just_Brew_It')
                 .property('name', 'Just_Brew_It')
                 .property('street', '826 Anmoore Road')
                 .property('address', 'San Bernardino CA 92410')
                 .property('pk', 'pk')"
...
~id,~from,~label,amount:Int,time:Date,status:String,~to
id1,Paul,HAS_BOUGHT_AT,986,2014-04-17,Undisputed,Just_Brew_It

"g.V('Paul').addE('knows').to(g.V('mary'))",
